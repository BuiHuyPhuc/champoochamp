...
class RouterConfig extends Component {
  ...
  render() {
    ...
    const { onRenderMenu, user, strShoppingCart, updateShoppingCart, getLoginUser, history } = this.props;
    
    return (
      <Switch>
        <Route exact path="/" component={Homepage} />
        <Route path='/dang-nhap' render={props =>
          (<LoginPage {...props} getLoginUser={getLoginUser} />)
        }
        />
        <Route path='/dang-ky' render={props =>
          (<RegisterPage {...props} getLoginUser={getLoginUser} history={history} />)
        }
        />
        ...
        <Route path="/chi-tiet/:product" render={props =>
          (<ProductDetail {...props} user={user} updateShoppingCart={updateShoppingCart} />)
        }
        />
        <Route path="/gio-hang" render={props =>
          (<Cart {...props} user={user} strShoppingCart={strShoppingCart} updateShoppingCart={updateShoppingCart} getDiscount={this.getDiscount} />)
        }
        />
        <Route path="/thanh-toan" render={props =>
          (<Payment {...props} user={user} updateShoppingCart={updateShoppingCart} discount={discount} history={history} />)
        }
        />
